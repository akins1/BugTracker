...
namespace BugTracker.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProjectDevelopersJunction",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectDevelopersJunction", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectManagedByJunction", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketAssignedToJunction", x => x.Id);
                });
